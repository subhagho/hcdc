...
public  final class DFSTransaction extends
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 16: {
            ...
            DFSTransaction.Operation value = DFSTransaction.Operation.valueOf(rawValue);
            if (value == null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return DFSBlockProto.internal_static_ai_sapper_hcdc_common_model_DFSTransaction_descriptor;
  }

  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return DFSBlockProto.internal_static_ai_sapper_hcdc_common_model_DFSTransaction_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            DFSTransaction.class, DFSTransaction.Builder.class);
  }
  ...
  public enum Operation
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return DFSTransaction.getDescriptor().getEnumTypes().get(0);
    }
  ...
  private DFSTransaction.Operation op_;
  /**
   ...
   * <code>required .ai_sapper_hcdc_common_model.DFSTransaction.Operation op = 2;</code>
   */
  public DFSTransaction.Operation getOp() {
    return op_;
  }
  ...
  private void initFields() {
    transactionId_ = 0L;
    op_ = DFSTransaction.Operation.ADD_FILE;
    timestamp_ = 0L;
  }
  ...
  public static DFSTransaction parseFrom(
  ...
  public static DFSTransaction parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static DFSTransaction parseFrom(
  ...
  public static DFSTransaction parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static DFSTransaction parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return PARSER.parseDelimitedFrom(input);
  }
  public static DFSTransaction parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(DFSTransaction prototype) {
  ...
  public static final class Builder extends
    ...
    public DFSTransaction getDefaultInstanceForType() {
      return DFSTransaction.getDefaultInstance();
    }

    public DFSTransaction build() {
      DFSTransaction result = buildPartial();
    ...
    public DFSTransaction buildPartial() {
      DFSTransaction result = new DFSTransaction(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof DFSTransaction) {
        return mergeFrom((DFSTransaction)other);
      } else {
    ...
    public Builder mergeFrom(DFSTransaction other) {
      if (other == DFSTransaction.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      DFSTransaction parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (DFSTransaction) e.getUnfinishedMessage();
        throw e;
      } finally {
    ...
    // required .ai_sapper_hcdc_common_model.DFSTransaction.Operation op = 2;
    private DFSTransaction.Operation op_ = DFSTransaction.Operation.ADD_FILE;
    /**
     * <code>required .ai_sapper_hcdc_common_model.DFSTransaction.Operation op = 2;</code>
     */
    public boolean hasOp() {
     ...
     * <code>required .ai_sapper_hcdc_common_model.DFSTransaction.Operation op = 2;</code>
     */
    public Builder setOp(DFSTransaction.Operation value) {
      if (value == null) {
