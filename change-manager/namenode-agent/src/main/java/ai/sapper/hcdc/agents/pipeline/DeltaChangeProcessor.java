...
public class DeltaChangeProcessor implements Runnable {
    private static Logger LOG = LoggerFactory.getLogger(DeltaChangeProcessor.class.getCanonicalName());

    private final ZkStateManager stateManager;
    private DeltaChangeProcessorConfig processorConfig;
    ...
    public DeltaChangeProcessor(@NonNull ZkStateManager stateManager) {
        this.stateManager = stateManager;
    }

    public DeltaChangeProcessor init(@NonNull HierarchicalConfiguration<ImmutableNode> xmlConfig,
                                     @NonNull ConnectionManager manger) throws ConfigurationException {
        try {
            processorConfig = new DeltaChangeProcessorConfig(xmlConfig);
    ...
    private SchemaEntity isRegistered(String hdfsPath) throws Exception {
