...
import ai.sapper.hcdc.agents.pipeline.FileDeltaProcessor;
...
public class FileChangeRunner {
    ...
    private FileDeltaProcessor processor;
    ...
    private void init() throws Exception {
        ...
        processor = new FileDeltaProcessor(NameNodeEnv.stateManager());
    ...
    public static void main(String[] args) {
        try {
            FileChangeRunner runner = new FileChangeRunner();
